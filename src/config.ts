...
export const AVAILABLE_MODELS = [
  { id: 'openai/gpt-5.5', name: 'GPT-5.5 Pro', features: { reasoning: true, caching: true } },
  { id: 'openai/gpt-5.5', name: 'GPT-5.5', features: { reasoning: true, caching: true } },
  { id: 'anthropic/claude-opus-4.7', name: 'Claude Opus 4.7', features: { reasoning: true, caching: true } },
  { id: 'google/gemini-3.1-pro-preview', name: 'Gemini 3.1 Pro Preview', features: { caching: true } },
  { id: 'x-ai/grok-4.20', name: 'Grok 4.20', features: { reasoning: true, caching: true } },
  { id: 'deepseek/deepseek-v4-pro', name: 'DeepSeek V4 Pro', features: { reasoning: true, caching: true } },
  { id: 'moonshotai/kimi-k2.6', name: 'Kimi K2.6', features: { reasoning: true, caching: true } },
